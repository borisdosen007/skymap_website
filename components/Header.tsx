...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 w-full">
      ...
      >
        {/* Lijevo – hamburger meni */}
        <button
          aria-label="Meni"
          className="flex items-center justify-start text-white/80 hover:text-white transition-colors"
        >
        ...
        <div className="flex items-center justify-end">
          <a
            ...
            className="flex items-center justify-center w-9 h-9 rounded-full border border-white/20 text-white/75 hover:text-white hover:border-white/40 transition-all duration-200"
          >
